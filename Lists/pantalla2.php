<html>
	...
	<?php
		if(is_numeric($_POST['elemento1'])==false)
		{
			...
			echo "<center><a href=http://localhost/listas/pantalla1.html>Haga Click aqui para continuar</a>";
			exit;
		...
		else if($_POST['elemento1']< 1)
		{
			...
			echo "<center><a href=http://localhost/listas/pantalla2.html>Haga Click aqui para continuar</a>";
			exit;
		}
	?>
